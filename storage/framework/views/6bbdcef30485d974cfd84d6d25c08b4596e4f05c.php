...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo e(asset("/bower_components/AdminLTE/plugins/iCheck/square/blue.css")); ?>">
</head>
    ...
    <div class="login-box-body">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <div class="form-group has-feedback">
                <input type="input" id="name" name="name" class="form-control" placeholder="用户名" value="<?php echo e(old('name')); ?>">
            ...
            <div class="form-group has-feedback">
                <input type="password" id="password" name="password" class="form-control" placeholder="密码" value="<?php echo e(old('password')); ?>">
