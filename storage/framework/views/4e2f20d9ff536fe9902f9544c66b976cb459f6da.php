<head>
    <meta charset="UTF-8">
    <title> OA - <?php echo $__env->yieldContent('htmlheader_title', 'Your title here'); ?> </title>
    ...
    <link href="<?php echo e(asset('/css/select2-bootstrap.css')); ?>" rel="stylesheet" type="text/css">
